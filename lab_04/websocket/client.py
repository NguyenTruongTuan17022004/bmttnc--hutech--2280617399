...
class WebSocketClient:
    ...
    def maybe_retry_connection(self, future) -> None:
        try:
            ...
            print("Connected!")
            self.connection.read_message(callback=self.on_message) # Start reading messages
    ...
    def on_message(self, message):
        ...
        self.connection.read_message(callback=self.on_message) # Continue reading messages
